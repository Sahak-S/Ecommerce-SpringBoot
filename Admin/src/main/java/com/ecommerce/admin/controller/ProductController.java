...
//        }
        List<ProductDto> productDtoList = productsService.findAll();
...
//            return "redirect:/login";
//        }
        Page<ProductDto> products = productsService.pageProducts(pageNo);
        model.addAttribute("title", "Manage Product");
...
//            return "redirect:/login";
//        }
        Page<ProductDto> products = productsService.searchProducts(pageNo, keyword);
...
//        }
    ...
    public String saveProduct(@ModelAttribute("product") ProductDto productDto,
        ...
        try {
productsService.save(imageProduct,productDto);
...
//        }
    ...
    public String processUpdate(@PathVariable("id") Long id,
        ...
        try {
            productsService.update(imageProduct, productDto);
